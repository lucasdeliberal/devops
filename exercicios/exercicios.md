...
```sh
$ sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run rancher/rancher-agent:v2.4.3 --server https://rancher.lucasdeliberal.com.br --token x2zqn5jhk8r4z5hq78c6l4sc9zwbgtxl9cqfc8rzgqnzwbxpwcpzrz --ca-checksum 6898ae0016602cd469dfbfe800e890cba527eb7c99b187efd3660bb408ef3f1c --node-name k8s-3 --etcd --controlplane --worker
```
